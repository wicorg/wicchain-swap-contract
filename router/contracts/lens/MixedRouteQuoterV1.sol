...
import '../base/core/libraries/SafeCast.sol';
import '../base/core/libraries/TickMath.sol';
import '../base/core/libraries/TickBitmap.sol';
import '../base/core/interfaces/IMonPool.sol';
import '../base/core/interfaces/callback/IMonSwapCallback.sol';
import '../base/periphery/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IMonSwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IMonPool;
    ...
    */
    ...
    /// @inheritdoc IMonSwapCallback
    function monSwapCallback(
        int256 amount0Delta,
        int256 amount1Delta,
        bytes memory path
        ...
        IMonPool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IMonPool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
