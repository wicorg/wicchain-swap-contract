...
import '../core/contracts/interfaces/callback/IMonSwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, IMonSwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IMonPool) {
        return IMonPool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function monSwapCallback(
        ...
        IMonPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IMonPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
