...
contract NonfungibleTokenPositionDescriptor is INonfungibleTokenPositionDescriptor {
    ...
    constructor(address _WMON, bytes32 _nativeCurrencyLabelBytes, address _nftDescriptorEx) {
        WMON = _WMON;
        ...
        return
            NFTDescriptorEx(nftDescriptorEx).constructTokenURI(
                NFTDescriptorEx.ConstructTokenURIParams({
                    ...
                    quoteTokenSymbol: quoteTokenAddress == WMON
                        ? nativeCurrencyLabel()
                        : SafeERC20Namer.tokenSymbol(quoteTokenAddress),
                    baseTokenSymbol: baseTokenAddress == WMON
                        ? nativeCurrencyLabel()
