...
import './interfaces/IMonLmPool.sol';
import './interfaces/IMasterChefV3.sol';
import './interfaces/IMonLmPoolDeveloper.sol';

contract MonLmPool is IMonLmPool {
  ...
  IMonPool public immutable pool;
  ...
  constructor() {
    (address poolAddress, address masterChefAddress) = IMonLmPoolDeveloper(msg.sender).parameters();
    pool = IMonPool(poolAddress);
