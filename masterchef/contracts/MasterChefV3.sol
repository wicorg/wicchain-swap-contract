...
contract MasterChefV3 is INonfungiblePositionManagerStruct, Multicall, Ownable, ReentrancyGuard, Enumerable {
    ...
    /// @dev Warning!!! Please make sure to use multicall to call unwrapWMON or sweepToken when set recipient address(0), or you will lose your funds.
    ...
    function unwrapWMON(uint256 amountMinimum, address recipient) external nonReentrant {
