...
import "./interfaces/IMonV3Pool.sol";
import "./interfaces/INonfungiblePositionManager.sol";
import "./interfaces/IMonV3Factory.sol";
...
contract FarmBooster is Ownable {
    ...
    /// @notice MonFactory contract.
    IMonFactory public immutable MonFactory;
    ...
    constructor(
        ...
        MonFactory = IMonFactory(NonfungiblePositionManager.factory());
    }
    ...
    function getUserMultiplier(uint256 _tokenId) external view returns (uint256) {
        ...
        if (pid == 0) {
            ...
            address v3PoolAddress = MonFactory.getPool(token0, token1, fee);
    ...
    function _getTotalLiquidity(
        ...
        uint256 v3PoolLiquidity = IMonPool(v3Pool).liquidity();
